...
// Unit Test randomization of race
const {raceRandomizer} = require('../randomizers');

test('should return Human when 1-75', () => {
    global.Math.random = () => 0.00;
    expect(raceRandomizer()).toEqual("Human");
    global.Math.random = () => 0.01;
    expect(raceRandomizer()).toEqual("Human");
    global.Math.random = () => 0.02;
    expect(raceRandomizer()).toEqual("Human");
...
test('should return Elf when 75-78', () => {
    global.Math.random = () => 0.74;
    expect(raceRandomizer()).toEqual("Elf");
    global.Math.random = () => 0.75;
    expect(raceRandomizer()).toEqual("Elf");
    global.Math.random = () => 0.76;
    expect(raceRandomizer()).toEqual("Elf");
...
test('should return Halfling when 79-81', () => {
    global.Math.random = () => 0.78;
    expect(raceRandomizer()).toEqual("Halfling");
    global.Math.random = () => 0.79;
    expect(raceRandomizer()).toEqual("Halfling");
    global.Math.random = () => 0.80;
    expect(raceRandomizer()).toEqual("Halfling");
...
test('should return Dwarf when 82-87', () => {
    global.Math.random = () => 0.81;
    expect(raceRandomizer()).toEqual("Dwarf");
    global.Math.random = () => 0.82;
    expect(raceRandomizer()).toEqual("Dwarf");
    global.Math.random = () => 0.83;
    expect(raceRandomizer()).toEqual("Dwarf");
...
test('should return Gnome when 88-90', () => {
    global.Math.random = () => 0.87;
    expect(raceRandomizer()).toEqual("Gnome");
    global.Math.random = () => 0.88;
    expect(raceRandomizer()).toEqual("Gnome");
    global.Math.random = () => 0.89;
    expect(raceRandomizer()).toEqual("Gnome");
...
test('should return Half-Orc when 91-95', () => {
    global.Math.random = () => 0.90;
    expect(raceRandomizer()).toEqual("Half-Orc");
    global.Math.random = () => 0.91;
    expect(raceRandomizer()).toEqual("Half-Orc");
    global.Math.random = () => 0.92;
    expect(raceRandomizer()).toEqual("Half-Orc");
...
test('should return Half-Elf when 96-100', () => {
    global.Math.random = () => 0.95;
    expect(raceRandomizer()).toEqual("Half-Elf");
    global.Math.random = () => 0.96;
    expect(raceRandomizer()).toEqual("Half-Elf");
    global.Math.random = () => 0.97;
    expect(raceRandomizer()).toEqual("Half-Elf");
